	...
	for (var i = 0; i < townsArray.length; i++) {
		if (townsArray[i].name != "Placerton") {
			...
			if (townsArray[i].name == "Springfield") {
				myImg.setAttribute("src", "images/opt-bicycle-bike-cycling.jpg");
			} else if (townsArray[i].name == "Greenville") {
				myImg.setAttribute("src", "images/opt-bicycle-bike-brakes.jpg");
			} else if (townsArray[i].name == "Franklin") {
				myImg.setAttribute("src", "images/opt-bicycle-bike-forests.jpg");
			}
